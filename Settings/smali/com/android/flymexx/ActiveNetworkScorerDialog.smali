.class public final Lcom/android/flymexx/ActiveNetworkScorerDialog;
...
.method private buildDialog()Z
    ...
    :cond_0
    iget-object v4, p0, Lcom/android/flymexx/ActiveNetworkScorerDialog;->mNewPackageName:Ljava/lang/String;
    ...
    iget-object v6, p0, Lcom/android/flymexx/ActiveNetworkScorerDialog;->mNewPackageName:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/android/flymexx/ActiveNetworkScorerDialog;->mNewPackageName:Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, Lcom/android/flymexx/ActiveNetworkScorerDialog;->setResult(I)V
    ...
    iget-object v3, p0, Lcom/android/flymexx/ActiveNetworkScorerDialog;->mAlertParams:Lcom/android/internal/app/AlertController$AlertParams;

    const v4, 0x7f0c076e

    invoke-virtual {p0, v4}, Lcom/android/flymexx/ActiveNetworkScorerDialog;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v5, v4}, Lcom/android/flymexx/ActiveNetworkScorerDialog;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/ActiveNetworkScorerDialog;->setupAlert()V
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/flymexx/ActiveNetworkScorerDialog;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/net/NetworkScoreManager;

    iget-object v1, p0, Lcom/android/flymexx/ActiveNetworkScorerDialog;->mNewPackageName:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lcom/android/flymexx/ActiveNetworkScorerDialog;->setResult(I)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/ActiveNetworkScorerDialog;->getIntent()Landroid/content/Intent;
    ...
    iput-object v1, p0, Lcom/android/flymexx/ActiveNetworkScorerDialog;->mNewPackageName:Ljava/lang/String;

    invoke-direct {p0}, Lcom/android/flymexx/ActiveNetworkScorerDialog;->buildDialog()Z

    move-result v1

    if-nez v1, :cond_0

    invoke-virtual {p0}, Lcom/android/flymexx/ActiveNetworkScorerDialog;->finish()V
