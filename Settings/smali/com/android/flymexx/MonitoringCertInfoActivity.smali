.class public Lcom/android/flymexx/MonitoringCertInfoActivity;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    const-string/jumbo v1, "com.android.flymexx.TRUSTED_CREDENTIALS_USER"
    ...
    iget v2, p0, Lcom/android/flymexx/MonitoringCertInfoActivity;->mUserId:I

    invoke-virtual {v0, v1, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    invoke-virtual {p0, v0}, Lcom/android/flymexx/MonitoringCertInfoActivity;->startActivity(Landroid/content/Intent;)V

    invoke-virtual {p0}, Lcom/android/flymexx/MonitoringCertInfoActivity;->finish()V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/MonitoringCertInfoActivity;->getIntent()Landroid/content/Intent;
    ...
    iput v5, p0, Lcom/android/flymexx/MonitoringCertInfoActivity;->mUserId:I

    const-class v5, Landroid/app/admin/DevicePolicyManager;

    invoke-virtual {p0, v5}, Lcom/android/flymexx/MonitoringCertInfoActivity;->getSystemService(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    iget v5, p0, Lcom/android/flymexx/MonitoringCertInfoActivity;->mUserId:I

    invoke-static {p0, v5}, Lcom/android/flymexxlib/RestrictedLockUtils;->getProfileOrDeviceOwner(Landroid/content/Context;I)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    ...
    :goto_0
    invoke-virtual {p0}, Lcom/android/flymexx/MonitoringCertInfoActivity;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual {p0, v3}, Lcom/android/flymexx/MonitoringCertInfoActivity;->setTitle(Ljava/lang/CharSequence;)V
    ...
    iget v7, p0, Lcom/android/flymexx/MonitoringCertInfoActivity;->mUserId:I
