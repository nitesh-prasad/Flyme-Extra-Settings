.class public Lcom/android/flymexx/PrivacySettings;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/flymexx/PrivacySettings$1;,
        Lcom/android/flymexx/PrivacySettings$PrivacySearchIndexProvider;
    }
.end annotation
...
# direct methods
.method static synthetic -get0(Lcom/android/flymexx/PrivacySettings;)Landroid/support/v14/preference/SwitchPreference;
    .locals 1

    iget-object v0, p0, Lcom/android/flymexx/PrivacySettings;->mAutoRestore:Landroid/support/v14/preference/SwitchPreference;

    return-object v0
.end method

.method static synthetic -get1(Lcom/android/flymexx/PrivacySettings;)Landroid/app/backup/IBackupManager;
    .locals 1

    iget-object v0, p0, Lcom/android/flymexx/PrivacySettings;->mBackupManager:Landroid/app/backup/IBackupManager;
...
.method static synthetic -wrap0(Landroid/content/Context;Ljava/util/Collection;)V
    ...
    invoke-static {p0, p1}, Lcom/android/flymexx/PrivacySettings;->getNonVisibleKeys(Landroid/content/Context;Ljava/util/Collection;)V
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/android/flymexx/PrivacySettings$PrivacySearchIndexProvider;

    invoke-direct {v0}, Lcom/android/flymexx/PrivacySettings$PrivacySearchIndexProvider;-><init>()V

    sput-object v0, Lcom/android/flymexx/PrivacySettings;->SEARCH_INDEX_DATA_PROVIDER:Lcom/android/flymexx/search/Indexable$SearchIndexProvider;
...
.method public constructor <init>()V
    ...
    new-instance v0, Lcom/android/flymexx/PrivacySettings$1;

    invoke-direct {v0, p0}, Lcom/android/flymexx/PrivacySettings$1;-><init>(Lcom/android/flymexx/PrivacySettings;)V

    iput-object v0, p0, Lcom/android/flymexx/PrivacySettings;->preferenceChangeListener:Landroid/support/v7/preference/Preference$OnPreferenceChangeListener;
...
.method private static getNonVisibleKeys(Landroid/content/Context;Ljava/util/Collection;)V
    ...
    invoke-static {p0, v4, v5}, Lcom/android/flymexxlib/RestrictedLockUtils;->hasBaseUserRestriction(Landroid/content/Context;Ljava/lang/String;I)Z
...
.method private setConfigureSummary(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/flymexx/PrivacySettings;->mConfigure:Landroid/support/v7/preference/PreferenceScreen;
...
.method private updateToggles()V
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/PrivacySettings;->getContentResolver()Landroid/content/ContentResolver;
    ...
    :try_start_0
    iget-object v12, p0, Lcom/android/flymexx/PrivacySettings;->mBackupManager:Landroid/app/backup/IBackupManager;
    ...
    invoke-direct {p0, v12, v13}, Lcom/android/flymexx/PrivacySettings;->validatedActivityIntent(Landroid/content/Intent;Ljava/lang/String;)Landroid/content/Intent;
    ...
    iget-object v13, p0, Lcom/android/flymexx/PrivacySettings;->mBackup:Landroid/support/v7/preference/PreferenceScreen;

    if-eqz v0, :cond_1

    const v12, 0x7f0c090f
    ...
    :goto_1
    iget-object v12, p0, Lcom/android/flymexx/PrivacySettings;->mAutoRestore:Landroid/support/v14/preference/SwitchPreference;
    ...
    iget-object v10, p0, Lcom/android/flymexx/PrivacySettings;->mAutoRestore:Landroid/support/v14/preference/SwitchPreference;
    ...
    :goto_3
    iget-object v10, p0, Lcom/android/flymexx/PrivacySettings;->mConfigure:Landroid/support/v7/preference/PreferenceScreen;
    ...
    invoke-direct {p0, v2}, Lcom/android/flymexx/PrivacySettings;->setConfigureSummary(Ljava/lang/String;)V
    ...
    iget-object v10, p0, Lcom/android/flymexx/PrivacySettings;->mManageData:Landroid/support/v7/preference/PreferenceScreen;
    ...
    iget-object v12, p0, Lcom/android/flymexx/PrivacySettings;->mBackup:Landroid/support/v7/preference/PreferenceScreen;
    ...
    :cond_5
    invoke-virtual {p0}, Lcom/android/flymexx/PrivacySettings;->getPreferenceScreen()Landroid/support/v7/preference/PreferenceScreen;

    move-result-object v10

    iget-object v11, p0, Lcom/android/flymexx/PrivacySettings;->mManageData:Landroid/support/v7/preference/PreferenceScreen;
...
.method private validatedActivityIntent(Landroid/content/Intent;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/PrivacySettings;->getPackageManager()Landroid/content/pm/PackageManager;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/PrivacySettings;->getActivity()Landroid/app/Activity;
    ...
    iput-boolean v5, p0, Lcom/android/flymexx/PrivacySettings;->mEnabled:Z

    iget-boolean v5, p0, Lcom/android/flymexx/PrivacySettings;->mEnabled:Z
    ...
    invoke-virtual {p0, v5}, Lcom/android/flymexx/PrivacySettings;->addPreferencesFromResource(I)V
    ...
    iput-object v5, p0, Lcom/android/flymexx/PrivacySettings;->mBackupManager:Landroid/app/backup/IBackupManager;
    ...
    iput-object v5, p0, Lcom/android/flymexx/PrivacySettings;->mBackup:Landroid/support/v7/preference/PreferenceScreen;
    ...
    iput-object v5, p0, Lcom/android/flymexx/PrivacySettings;->mAutoRestore:Landroid/support/v14/preference/SwitchPreference;

    iget-object v5, p0, Lcom/android/flymexx/PrivacySettings;->mAutoRestore:Landroid/support/v14/preference/SwitchPreference;

    iget-object v6, p0, Lcom/android/flymexx/PrivacySettings;->preferenceChangeListener:Landroid/support/v7/preference/Preference$OnPreferenceChangeListener;
    ...
    iput-object v5, p0, Lcom/android/flymexx/PrivacySettings;->mConfigure:Landroid/support/v7/preference/PreferenceScreen;
    ...
    iput-object v5, p0, Lcom/android/flymexx/PrivacySettings;->mManageData:Landroid/support/v7/preference/PreferenceScreen;
    ...
    invoke-static {v5, v1}, Lcom/android/flymexx/PrivacySettings;->getNonVisibleKeys(Landroid/content/Context;Ljava/util/Collection;)V
    ...
    :cond_2
    invoke-direct {p0}, Lcom/android/flymexx/PrivacySettings;->updateToggles()V
...
.method public onResume()V
    ...
    iget-boolean v0, p0, Lcom/android/flymexx/PrivacySettings;->mEnabled:Z
