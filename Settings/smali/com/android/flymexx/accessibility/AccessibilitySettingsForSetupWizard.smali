.class public Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;
...
.method static constructor <clinit>()V
    ...
    const-class v0, Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;->TAG:Ljava/lang/String;
...
.method private findFirstServiceWithSpokenFeedback()Landroid/accessibilityservice/AccessibilityServiceInfo;
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;->getActivity()Landroid/app/Activity;
...
.method private updateScreenReaderPreference()V
    ...
    invoke-direct {p0}, Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;->findFirstServiceWithSpokenFeedback()Landroid/accessibilityservice/AccessibilityServiceInfo;

    move-result-object v3

    if-nez v3, :cond_0

    iget-object v6, p0, Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;->mScreenReaderPreference:Landroid/support/v7/preference/Preference;
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    iget-object v7, p0, Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;->mScreenReaderPreference:Landroid/support/v7/preference/Preference;
    ...
    invoke-virtual {p0, v6}, Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;->getString(I)Ljava/lang/String;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;->setHasOptionsMenu(Z)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;->addPreferencesFromResource(I)V

    const-string/jumbo v0, "screen_magnification_preference"

    invoke-virtual {p0, v0}, Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;

    move-result-object v0

    iput-object v0, p0, Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;->mDisplayMagnificationPreference:Landroid/support/v7/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;->mScreenReaderPreference:Landroid/support/v7/preference/Preference;
...
.method public onPreferenceTreeClick(Landroid/support/v7/preference/Preference;)Z
    ...
    iget-object v3, p0, Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;->mDisplayMagnificationPreference:Landroid/support/v7/preference/Preference;
    ...
    invoke-virtual {p0, v4}, Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;->getText(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;->getContentResolver()Landroid/content/ContentResolver;
...
.method public onResume()V
    ...
    invoke-direct {p0}, Lcom/android/flymexx/accessibility/AccessibilitySettingsForSetupWizard;->updateScreenReaderPreference()V
