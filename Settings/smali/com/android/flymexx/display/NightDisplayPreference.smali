.class public Lcom/android/flymexx/display/NightDisplayPreference;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Lcom/android/flymexx/display/NightDisplayPreference;->mController:Lcom/android/internal/app/NightDisplayController;

    invoke-static {p1}, Landroid/text/format/DateFormat;->getTimeFormat(Landroid/content/Context;)Ljava/text/DateFormat;

    move-result-object v0

    iput-object v0, p0, Lcom/android/flymexx/display/NightDisplayPreference;->mTimeFormatter:Ljava/text/DateFormat;

    iget-object v0, p0, Lcom/android/flymexx/display/NightDisplayPreference;->mTimeFormatter:Ljava/text/DateFormat;
...
.method private getFormattedTimeString(Lcom/android/internal/app/NightDisplayController$LocalTime;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/flymexx/display/NightDisplayPreference;->mTimeFormatter:Ljava/text/DateFormat;
...
.method private updateSummary()V
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/display/NightDisplayPreference;->getContext()Landroid/content/Context;

    move-result-object v2

    iget-object v5, p0, Lcom/android/flymexx/display/NightDisplayPreference;->mController:Lcom/android/internal/app/NightDisplayController;
    ...
    invoke-virtual {p0, v5}, Lcom/android/flymexx/display/NightDisplayPreference;->setSummary(Ljava/lang/CharSequence;)V
    ...
    iget-object v6, p0, Lcom/android/flymexx/display/NightDisplayPreference;->mController:Lcom/android/internal/app/NightDisplayController;
    ...
    invoke-direct {p0, v6}, Lcom/android/flymexx/display/NightDisplayPreference;->getFormattedTimeString(Lcom/android/internal/app/NightDisplayController$LocalTime;)Ljava/lang/String;
...
.method public onActivated(Z)V
    ...
    invoke-direct {p0}, Lcom/android/flymexx/display/NightDisplayPreference;->updateSummary()V
...
.method public onAttached()V
    ...
    invoke-super {p0}, Lcyanogenmod/preference/SelfRemovingSwitchPreference;->onAttached()V

    iget-object v0, p0, Lcom/android/flymexx/display/NightDisplayPreference;->mController:Lcom/android/internal/app/NightDisplayController;
...
.method public onDetached()V
    ...
    invoke-super {p0}, Lcyanogenmod/preference/SelfRemovingSwitchPreference;->onDetached()V
