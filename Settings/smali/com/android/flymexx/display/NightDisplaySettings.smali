.class public Lcom/android/flymexx/display/NightDisplaySettings;
...
# direct methods
.method static synthetic -get0(Lcom/android/flymexx/display/NightDisplaySettings;)Lcom/android/internal/app/NightDisplayController;
    .locals 1

    iget-object v0, p0, Lcom/android/flymexx/display/NightDisplaySettings;->mController:Lcom/android/internal/app/NightDisplayController;
...
.method private getFormattedTimeString(Lcom/android/internal/app/NightDisplayController$LocalTime;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/flymexx/display/NightDisplaySettings;->mTimeFormatter:Ljava/text/DateFormat;
...
.method public onActivated(Z)V
    ...
    iget-object v0, p0, Lcom/android/flymexx/display/NightDisplaySettings;->mActivatedPreference:Landroid/support/v7/preference/TwoStatePreference;
...
.method public onAutoModeChanged(I)V
    ...
    iget-object v1, p0, Lcom/android/flymexx/display/NightDisplaySettings;->mAutoModePreference:Landroid/support/v7/preference/DropDownPreference;
    ...
    :goto_0
    iget-object v1, p0, Lcom/android/flymexx/display/NightDisplaySettings;->mStartTimePreference:Landroid/support/v7/preference/Preference;

    invoke-virtual {v1, v0}, Landroid/support/v7/preference/Preference;->setVisible(Z)V

    iget-object v1, p0, Lcom/android/flymexx/display/NightDisplaySettings;->mEndTimePreference:Landroid/support/v7/preference/Preference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/display/NightDisplaySettings;->getContext()Landroid/content/Context;
    ...
    iput-object v1, p0, Lcom/android/flymexx/display/NightDisplaySettings;->mController:Lcom/android/internal/app/NightDisplayController;

    invoke-static {v0}, Landroid/text/format/DateFormat;->getTimeFormat(Landroid/content/Context;)Ljava/text/DateFormat;

    move-result-object v1

    iput-object v1, p0, Lcom/android/flymexx/display/NightDisplaySettings;->mTimeFormatter:Ljava/text/DateFormat;
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    new-instance v2, Lcom/android/flymexx/display/NightDisplaySettings$1;

    invoke-direct {v2, p0, p1}, Lcom/android/flymexx/display/NightDisplaySettings$1;-><init>(Lcom/android/flymexx/display/NightDisplaySettings;I)V
...
.method public onCreatePreferences(Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    invoke-super {p0, p1, p2}, Lcom/android/flymexx/SettingsPreferenceFragment;->onCreatePreferences(Landroid/os/Bundle;Ljava/lang/String;)V

    const v0, 0x7f08003c

    invoke-virtual {p0, v0}, Lcom/android/flymexx/display/NightDisplaySettings;->addPreferencesFromResource(I)V

    const-string/jumbo v0, "night_display_auto_mode"

    invoke-virtual {p0, v0}, Lcom/android/flymexx/display/NightDisplaySettings;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;

    move-result-object v0

    check-cast v0, Landroid/support/v7/preference/DropDownPreference;

    iput-object v0, p0, Lcom/android/flymexx/display/NightDisplaySettings;->mAutoModePreference:Landroid/support/v7/preference/DropDownPreference;
    ...
    iput-object v0, p0, Lcom/android/flymexx/display/NightDisplaySettings;->mStartTimePreference:Landroid/support/v7/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/flymexx/display/NightDisplaySettings;->mEndTimePreference:Landroid/support/v7/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/flymexx/display/NightDisplaySettings;->mActivatedPreference:Landroid/support/v7/preference/TwoStatePreference;

    iget-object v0, p0, Lcom/android/flymexx/display/NightDisplaySettings;->mAutoModePreference:Landroid/support/v7/preference/DropDownPreference;

    new-array v1, v6, [Ljava/lang/CharSequence;

    const v2, 0x7f0c0625

    invoke-virtual {p0, v2}, Lcom/android/flymexx/display/NightDisplaySettings;->getString(I)Ljava/lang/String;
...
.method public onCustomEndTimeChanged(Lcom/android/internal/app/NightDisplayController$LocalTime;)V
    ...
    iget-object v0, p0, Lcom/android/flymexx/display/NightDisplaySettings;->mEndTimePreference:Landroid/support/v7/preference/Preference;

    invoke-direct {p0, p1}, Lcom/android/flymexx/display/NightDisplaySettings;->getFormattedTimeString(Lcom/android/internal/app/NightDisplayController$LocalTime;)Ljava/lang/String;
...
.method public onCustomStartTimeChanged(Lcom/android/internal/app/NightDisplayController$LocalTime;)V
    ...
    iget-object v0, p0, Lcom/android/flymexx/display/NightDisplaySettings;->mStartTimePreference:Landroid/support/v7/preference/Preference;
...
.method public onPreferenceTreeClick(Landroid/support/v7/preference/Preference;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/flymexx/display/NightDisplaySettings;->showDialog(I)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/flymexx/display/NightDisplaySettings;->showDialog(I)V
...
.method public onStart()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/flymexx/display/NightDisplaySettings;->onActivated(Z)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/flymexx/display/NightDisplaySettings;->onAutoModeChanged(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/flymexx/display/NightDisplaySettings;->onCustomStartTimeChanged(Lcom/android/internal/app/NightDisplayController$LocalTime;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/flymexx/display/NightDisplaySettings;->onCustomEndTimeChanged(Lcom/android/internal/app/NightDisplayController$LocalTime;)V
