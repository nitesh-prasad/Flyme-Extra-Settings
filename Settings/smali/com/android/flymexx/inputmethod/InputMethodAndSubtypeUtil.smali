.class Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->sStringInputMethodSplitter:Landroid/text/TextUtils$SimpleStringSplitter;
    ...
    sput-object v0, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->sStringInputMethodSubtypeSplitter:Landroid/text/TextUtils$SimpleStringSplitter;
...
.method static enableInputMethodSubtypesOf(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/util/HashSet;)V
    ...
    invoke-static {p0}, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->getEnabledInputMethodsAndSubtypeList(Landroid/content/ContentResolver;)Ljava/util/HashMap;

    move-result-object v0

    invoke-virtual {v0, p1, p2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {v0}, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->buildInputMethodsAndSubtypesString(Ljava/util/HashMap;)Ljava/lang/String;
...
.method private static getDisabledSystemIMEs(Landroid/content/ContentResolver;)Ljava/util/HashSet;
    ...
    :cond_0
    sget-object v2, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->sStringInputMethodSplitter:Landroid/text/TextUtils$SimpleStringSplitter;
...
.method private static getEnabledInputMethodsAndSubtypeList(Landroid/content/ContentResolver;)Ljava/util/HashMap;
    ...
    invoke-static {v0}, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->parseInputMethodsAndSubtypesString(Ljava/lang/String;)Ljava/util/HashMap;
...
.method static getSubtypeLocaleNameAsSentence(Landroid/view/inputmethod/InputMethodSubtype;Landroid/content/Context;Landroid/view/inputmethod/InputMethodInfo;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p1}, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->getDisplayLocale(Landroid/content/Context;)Ljava/util/Locale;
...
.method private static isInputMethodSubtypeSelected(Landroid/content/ContentResolver;)Z
    ...
    invoke-static {p0}, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->getInputMethodSubtypeSelected(Landroid/content/ContentResolver;)I
...
.method static loadInputMethodSubtypeList(Lcom/android/flymexx/SettingsPreferenceFragment;Landroid/content/ContentResolver;Ljava/util/List;Ljava/util/Map;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1}, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->getEnabledInputMethodsAndSubtypeList(Landroid/content/ContentResolver;)Ljava/util/HashMap;
    ...
    invoke-virtual {p0, v5}, Lcom/android/flymexx/SettingsPreferenceFragment;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;
    ...
    :cond_1
    invoke-static {p0, p2, v5, v6}, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->setSubtypesPreferenceEnabled(Lcom/android/flymexx/SettingsPreferenceFragment;Ljava/util/List;Ljava/lang/String;Z)V

    goto :goto_0

    :cond_2
    invoke-static {p0, p2, v2}, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->updateSubtypesPreferenceChecked(Lcom/android/flymexx/SettingsPreferenceFragment;Ljava/util/List;Ljava/util/HashMap;)V
...
.method static parseInputMethodsAndSubtypesString(Ljava/lang/String;)Ljava/util/HashMap;
    ...
    :cond_0
    sget-object v4, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->sStringInputMethodSplitter:Landroid/text/TextUtils$SimpleStringSplitter;
    ...
    sget-object v4, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->sStringInputMethodSubtypeSplitter:Landroid/text/TextUtils$SimpleStringSplitter;
...
.method static saveInputMethodSubtypeList(Lcom/android/flymexx/SettingsPreferenceFragment;Landroid/content/ContentResolver;Ljava/util/List;Z)V
    .locals 25
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static/range {p1 .. p1}, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->getInputMethodSubtypeSelected(Landroid/content/ContentResolver;)I

    move-result v15

    invoke-static/range {p1 .. p1}, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->getEnabledInputMethodsAndSubtypeList(Landroid/content/ContentResolver;)Ljava/util/HashMap;

    move-result-object v5

    invoke-static/range {p1 .. p1}, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->getDisabledSystemIMEs(Landroid/content/ContentResolver;)Ljava/util/HashSet;
    ...
    invoke-virtual {v0, v10}, Lcom/android/flymexx/SettingsPreferenceFragment;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/flymexx/SettingsPreferenceFragment;->getActivity()Landroid/app/Activity;

    move-result-object v23

    invoke-static/range {v23 .. v23}, Lcom/android/flymexx/inputmethod/InputMethodSettingValuesWrapper;->getInstance(Landroid/content/Context;)Lcom/android/flymexx/inputmethod/InputMethodSettingValuesWrapper;
    ...
    invoke-virtual {v0, v8, v1}, Lcom/android/flymexx/inputmethod/InputMethodSettingValuesWrapper;->isAlwaysCheckedIme(Landroid/view/inputmethod/InputMethodInfo;Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/flymexx/SettingsPreferenceFragment;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;
    ...
    :cond_c
    invoke-static {v5}, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->buildInputMethodsAndSubtypesString(Ljava/util/HashMap;)Ljava/lang/String;

    move-result-object v6

    invoke-static {v3}, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->buildInputMethodsString(Ljava/util/HashSet;)Ljava/lang/String;

    move-result-object v4

    if-nez v13, :cond_e

    invoke-static/range {p1 .. p1}, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->isInputMethodSubtypeSelected(Landroid/content/ContentResolver;)Z
    ...
    invoke-static {v0, v1}, Lcom/android/flymexx/inputmethod/InputMethodAndSubtypeUtil;->putSelectedInputMethodSubtype(Landroid/content/ContentResolver;I)V
...
.method static setSubtypesPreferenceEnabled(Lcom/android/flymexx/SettingsPreferenceFragment;Ljava/util/List;Ljava/lang/String;Z)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static updateSubtypesPreferenceChecked(Lcom/android/flymexx/SettingsPreferenceFragment;Ljava/util/List;Ljava/util/HashMap;)V
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
