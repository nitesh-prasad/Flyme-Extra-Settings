.class public Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceId:I

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->mPreferenceMap:Ljava/util/HashMap;
...
.method private createPreferenceHierarchy()Landroid/support/v7/preference/PreferenceScreen;
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->getPreferenceManager()Landroid/support/v7/preference/PreferenceManager;

    move-result-object v4

    invoke-virtual {p0}, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->getActivity()Landroid/app/Activity;
    ...
    iget-object v5, p0, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->mKeyboardLayouts:[Landroid/hardware/input/KeyboardLayout;
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->getPrefContext()Landroid/content/Context;
    ...
    iget-object v7, p0, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->mPreferenceMap:Ljava/util/HashMap;
...
.method private updateCheckedState()V
    ...
    iget-object v3, p0, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;

    iget-object v4, p0, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceIdentifier:Landroid/hardware/input/InputDeviceIdentifier;
    ...
    iget-object v3, p0, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->mPreferenceMap:Ljava/util/HashMap;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceIdentifier:Landroid/hardware/input/InputDeviceIdentifier;

    iget-object v0, p0, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceIdentifier:Landroid/hardware/input/InputDeviceIdentifier;
    ...
    invoke-virtual {p0, v0}, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/hardware/input/InputManager;

    iput-object v0, p0, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;

    iget-object v0, p0, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;

    iget-object v1, p0, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceIdentifier:Landroid/hardware/input/InputDeviceIdentifier;
    ...
    iput-object v0, p0, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->mKeyboardLayouts:[Landroid/hardware/input/KeyboardLayout;

    iget-object v0, p0, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->mKeyboardLayouts:[Landroid/hardware/input/KeyboardLayout;

    invoke-static {v0}, Ljava/util/Arrays;->sort([Ljava/lang/Object;)V

    invoke-direct {p0}, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->createPreferenceHierarchy()Landroid/support/v7/preference/PreferenceScreen;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->setPreferenceScreen(Landroid/support/v7/preference/PreferenceScreen;)V
...
.method public onInputDeviceChanged(I)V
    ...
    iget v0, p0, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceId:I
    ...
    invoke-direct {p0}, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->updateCheckedState()V
...
.method public onResume()V
    ...
    iget-object v1, p0, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;
    ...
    iget-object v2, p0, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceIdentifier:Landroid/hardware/input/InputDeviceIdentifier;
    ...
    iput v1, p0, Lcom/android/flymexx/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceId:I
