.class public Lcom/android/flymexx/inputmethod/UserDictionaryList;
...
.method protected createUserDictSettings(Landroid/support/v7/preference/PreferenceGroup;)V
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/inputmethod/UserDictionaryList;->getActivity()Landroid/app/Activity;
    ...
    iget-object v4, p0, Lcom/android/flymexx/inputmethod/UserDictionaryList;->mLocale:Ljava/lang/String;
    ...
    invoke-virtual {p0, v6, v0}, Lcom/android/flymexx/inputmethod/UserDictionaryList;->createUserDictionaryPreference(Ljava/lang/String;Landroid/app/Activity;)Landroid/support/v7/preference/Preference;
    ...
    invoke-virtual {p0, v1, v0}, Lcom/android/flymexx/inputmethod/UserDictionaryList;->createUserDictionaryPreference(Ljava/lang/String;Landroid/app/Activity;)Landroid/support/v7/preference/Preference;
...
.method protected createUserDictionaryPreference(Ljava/lang/String;Landroid/app/Activity;)Landroid/support/v7/preference/Preference;
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/inputmethod/UserDictionaryList;->getPrefContext()Landroid/content/Context;
    ...
    const-class v2, Lcom/android/flymexx/UserDictionarySettings;
    ...
    invoke-virtual {p0, v2}, Lcom/android/flymexx/inputmethod/UserDictionaryList;->getString(I)Ljava/lang/String;
    ...
    :cond_1
    invoke-static {p1}, Lcom/android/flymexx/Utils;->createLocaleFromString(Ljava/lang/String;)Ljava/util/Locale;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    :goto_0
    invoke-virtual {p0}, Lcom/android/flymexx/inputmethod/UserDictionaryList;->getArguments()Landroid/os/Bundle;
    ...
    :goto_2
    iput-object v2, p0, Lcom/android/flymexx/inputmethod/UserDictionaryList;->mLocale:Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/inputmethod/UserDictionaryList;->getPreferenceManager()Landroid/support/v7/preference/PreferenceManager;
    ...
    invoke-virtual {p0, v0}, Lcom/android/flymexx/inputmethod/UserDictionaryList;->setPreferenceScreen(Landroid/support/v7/preference/PreferenceScreen;)V
...
.method public onResume()V
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/inputmethod/UserDictionaryList;->getPreferenceScreen()Landroid/support/v7/preference/PreferenceScreen;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/android/flymexx/inputmethod/UserDictionaryList;->createUserDictSettings(Landroid/support/v7/preference/PreferenceGroup;)V
