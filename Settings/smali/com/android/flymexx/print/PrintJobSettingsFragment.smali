.class public Lcom/android/flymexx/print/PrintJobSettingsFragment;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/flymexx/print/PrintJobSettingsFragment$1;
    }
.end annotation
...
# direct methods
.method static synthetic -wrap0(Lcom/android/flymexx/print/PrintJobSettingsFragment;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/flymexx/print/PrintJobSettingsFragment;->updateUi()V
...
.method public constructor <init>()V
    ...
    new-instance v0, Lcom/android/flymexx/print/PrintJobSettingsFragment$1;

    invoke-direct {v0, p0}, Lcom/android/flymexx/print/PrintJobSettingsFragment$1;-><init>(Lcom/android/flymexx/print/PrintJobSettingsFragment;)V

    iput-object v0, p0, Lcom/android/flymexx/print/PrintJobSettingsFragment;->mPrintJobStateChangeListener:Landroid/print/PrintManager$PrintJobStateChangeListener;
...
.method private getPrintJob()Landroid/print/PrintJob;
    ...
    iget-object v0, p0, Lcom/android/flymexx/print/PrintJobSettingsFragment;->mPrintManager:Landroid/print/PrintManager;

    iget-object v1, p0, Lcom/android/flymexx/print/PrintJobSettingsFragment;->mPrintJobId:Landroid/print/PrintJobId;
...
.method private processArguments()V
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/print/PrintJobSettingsFragment;->getArguments()Landroid/os/Bundle;
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/print/PrintJobSettingsFragment;->finish()V
    ...
    iput-object v1, p0, Lcom/android/flymexx/print/PrintJobSettingsFragment;->mPrintJobId:Landroid/print/PrintJobId;
...
.method private updateUi()V
    ...
    invoke-direct {p0}, Lcom/android/flymexx/print/PrintJobSettingsFragment;->getPrintJob()Landroid/print/PrintJob;
    ...
    :goto_0
    :pswitch_0
    iget-object v9, p0, Lcom/android/flymexx/print/PrintJobSettingsFragment;->mPrintJobPreference:Landroid/support/v7/preference/Preference;
    ...
    invoke-virtual {p0, v0, v10}, Lcom/android/flymexx/print/PrintJobSettingsFragment;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    :goto_1
    :pswitch_1
    invoke-virtual {p0}, Lcom/android/flymexx/print/PrintJobSettingsFragment;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/print/PrintJobSettingsFragment;->getPreferenceScreen()Landroid/support/v7/preference/PreferenceScreen;
    ...
    iget-object v1, p0, Lcom/android/flymexx/print/PrintJobSettingsFragment;->mMessagePreference:Landroid/support/v7/preference/Preference;

    invoke-virtual {v0, v1}, Landroid/support/v7/preference/PreferenceScreen;->addPreference(Landroid/support/v7/preference/Preference;)Z

    :cond_3
    iget-object v0, p0, Lcom/android/flymexx/print/PrintJobSettingsFragment;->mMessagePreference:Landroid/support/v7/preference/Preference;

    invoke-virtual {v0, v8}, Landroid/support/v7/preference/Preference;->setSummary(Ljava/lang/CharSequence;)V

    :goto_2
    invoke-virtual {p0}, Lcom/android/flymexx/print/PrintJobSettingsFragment;->getActivity()Landroid/app/Activity;
    ...
    iget-object v0, p0, Lcom/android/flymexx/print/PrintJobSettingsFragment;->mPrintJobPreference:Landroid/support/v7/preference/Preference;
    ...
    invoke-virtual {p0, v2, v1}, Lcom/android/flymexx/print/PrintJobSettingsFragment;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v5, v1}, Lcom/android/flymexx/print/PrintJobSettingsFragment;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    invoke-virtual {p0, v3}, Lcom/android/flymexx/print/PrintJobSettingsFragment;->getString(I)Ljava/lang/String;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-virtual {p0, v1}, Lcom/android/flymexx/print/PrintJobSettingsFragment;->addPreferencesFromResource(I)V

    const-string/jumbo v1, "print_job_preference"

    invoke-virtual {p0, v1}, Lcom/android/flymexx/print/PrintJobSettingsFragment;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;

    move-result-object v1

    iput-object v1, p0, Lcom/android/flymexx/print/PrintJobSettingsFragment;->mPrintJobPreference:Landroid/support/v7/preference/Preference;
    ...
    iput-object v1, p0, Lcom/android/flymexx/print/PrintJobSettingsFragment;->mMessagePreference:Landroid/support/v7/preference/Preference;
    ...
    iput-object v1, p0, Lcom/android/flymexx/print/PrintJobSettingsFragment;->mPrintManager:Landroid/print/PrintManager;
    ...
    invoke-direct {p0}, Lcom/android/flymexx/print/PrintJobSettingsFragment;->processArguments()V

    const/4 v1, 0x1

    invoke-virtual {p0, v1}, Lcom/android/flymexx/print/PrintJobSettingsFragment;->setHasOptionsMenu(Z)V
...
.method public onStart()V
    ...
    iget-object v1, p0, Lcom/android/flymexx/print/PrintJobSettingsFragment;->mPrintJobStateChangeListener:Landroid/print/PrintManager$PrintJobStateChangeListener;
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/print/PrintJobSettingsFragment;->getListView()Landroid/support/v7/widget/RecyclerView;
