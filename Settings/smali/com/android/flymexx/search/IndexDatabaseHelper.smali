.class public Lcom/android/flymexx/search/IndexDatabaseHelper;
...
.field private static sSingleton:Lcom/android/flymexx/search/IndexDatabaseHelper;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/flymexx/search/IndexDatabaseHelper;->INSERT_BUILD_VERSION:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/android/flymexx/search/IndexDatabaseHelper;->mContext:Landroid/content/Context;
...
.method private bootstrapDB(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    sget-object v0, Lcom/android/flymexx/search/IndexDatabaseHelper;->INSERT_BUILD_VERSION:Ljava/lang/String;
...
.method private dropTables(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    iget-object v0, p0, Lcom/android/flymexx/search/IndexDatabaseHelper;->mContext:Landroid/content/Context;

    invoke-static {v0}, Lcom/android/flymexx/search/IndexDatabaseHelper;->clearLocalesIndexed(Landroid/content/Context;)V
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/android/flymexx/search/IndexDatabaseHelper;
    .locals 2

    const-class v1, Lcom/android/flymexx/search/IndexDatabaseHelper;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/android/flymexx/search/IndexDatabaseHelper;->sSingleton:Lcom/android/flymexx/search/IndexDatabaseHelper;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/flymexx/search/IndexDatabaseHelper;

    invoke-direct {v0, p0}, Lcom/android/flymexx/search/IndexDatabaseHelper;-><init>(Landroid/content/Context;)V

    sput-object v0, Lcom/android/flymexx/search/IndexDatabaseHelper;->sSingleton:Lcom/android/flymexx/search/IndexDatabaseHelper;
...
.method private reconstruct(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/flymexx/search/IndexDatabaseHelper;->dropTables(Landroid/database/sqlite/SQLiteDatabase;)V

    invoke-direct {p0, p1}, Lcom/android/flymexx/search/IndexDatabaseHelper;->bootstrapDB(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public onDowngrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    invoke-direct {p0, p1}, Lcom/android/flymexx/search/IndexDatabaseHelper;->reconstruct(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/flymexx/search/IndexDatabaseHelper;->getBuildVersion(Landroid/database/sqlite/SQLiteDatabase;)Ljava/lang/String;
