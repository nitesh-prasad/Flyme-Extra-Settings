.class public Lcom/android/flymexx/wifi/WifiDialogActivity;
...
.method public finish()V
    ...
    invoke-virtual {p0, v0, v0}, Lcom/android/flymexx/wifi/WifiDialogActivity;->overridePendingTransition(II)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/wifi/WifiDialogActivity;->getIntent()Landroid/content/Intent;
    ...
    invoke-static {v3}, Lcom/android/flymexx/SetupWizardUtils;->getTransparentTheme(Landroid/content/Intent;)I

    move-result v4

    invoke-virtual {p0, v4}, Lcom/android/flymexx/wifi/WifiDialogActivity;->setTheme(I)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/flymexxlib/wifi/AccessPoint;-><init>(Landroid/content/Context;Landroid/os/Bundle;)V

    :cond_1
    new-instance v2, Lcom/android/flymexx/wifi/WifiDialog;

    const/4 v4, 0x1

    invoke-direct {v2, p0, p0, v0, v4}, Lcom/android/flymexx/wifi/WifiDialog;-><init>(Landroid/content/Context;Lcom/android/flymexx/wifi/WifiDialog$WifiDialogListener;Lcom/android/flymexxlib/wifi/AccessPoint;I)V

    invoke-virtual {v2}, Lcom/android/flymexx/wifi/WifiDialog;->show()V

    invoke-virtual {v2, p0}, Lcom/android/flymexx/wifi/WifiDialog;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    invoke-virtual {p0}, Lcom/android/flymexx/wifi/WifiDialogActivity;->finish()V
...
.method public onForget(Lcom/android/flymexx/wifi/WifiDialog;)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/flymexx/wifi/WifiDialogActivity;->getSystemService(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Landroid/net/wifi/WifiManager;

    invoke-virtual {p1}, Lcom/android/flymexx/wifi/WifiDialog;->getController()Lcom/android/flymexx/wifi/WifiConfigController;

    move-result-object v4

    invoke-virtual {v4}, Lcom/android/flymexx/wifi/WifiConfigController;->getAccessPoint()Lcom/android/flymexxlib/wifi/AccessPoint;
    ...
    invoke-static {v4}, Lcom/android/flymexxlib/wifi/AccessPoint;->convertToQuotedString(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, Lcom/android/flymexx/wifi/WifiDialogActivity;->setResult(I)V
...
.method public onSubmit(Lcom/android/flymexx/wifi/WifiDialog;)V
    ...
    invoke-virtual {v6}, Lcom/android/flymexx/wifi/WifiConfigController;->getConfig()Landroid/net/wifi/WifiConfiguration;
    ...
    invoke-virtual {v6}, Lcom/android/flymexx/wifi/WifiConfigController;->getAccessPoint()Lcom/android/flymexxlib/wifi/AccessPoint;

    move-result-object v0

    const-class v6, Landroid/net/wifi/WifiManager;

    invoke-virtual {p0, v6}, Lcom/android/flymexx/wifi/WifiDialogActivity;->getSystemService(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v6, v4}, Lcom/android/flymexx/wifi/WifiDialogActivity;->setResult(ILandroid/content/Intent;)V
