.class public Lcom/android/flymexxlib/HelpUtils;
...
.method static synthetic -get0()Ljava/lang/String;
    ...
    sget-object v0, Lcom/android/flymexxlib/HelpUtils;->TAG:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    const-class v0, Lcom/android/flymexxlib/HelpUtils;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/android/flymexxlib/HelpUtils;->TAG:Ljava/lang/String;

    const/4 v0, 0x0

    sput-object v0, Lcom/android/flymexxlib/HelpUtils;->sCachedVersionCode:Ljava/lang/String;
...
.method public static addIntentParameters(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;Z)V
    ...
    sget v9, Lcom/android/flymexxlib/R$bool;->config_sendPackageName:I
    ...
    sget v9, Lcom/android/flymexxlib/R$string;->config_helpPackageNameKey:I
    ...
    sget v9, Lcom/android/flymexxlib/R$string;->config_helpPackageNameValue:I
    ...
    sget v9, Lcom/android/flymexxlib/R$string;->config_helpIntentExtraKey:I

    invoke-virtual {v8, v9}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v3

    sget v9, Lcom/android/flymexxlib/R$string;->config_helpIntentNameKey:I

    invoke-virtual {v8, v9}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v4

    sget v9, Lcom/android/flymexxlib/R$string;->config_feedbackIntentExtraKey:I

    invoke-virtual {v8, v9}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v1

    sget v9, Lcom/android/flymexxlib/R$string;->config_feedbackIntentNameKey:I
...
.method public static getHelpIntent(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p0, v3, p2, v4}, Lcom/android/flymexxlib/HelpUtils;->addIntentParameters(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;Z)V
    ...
    invoke-static {p0, v4, p2}, Lcom/android/flymexxlib/HelpUtils;->getHelpIntent(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    :try_end_0
    ...
    invoke-static {p0, v4}, Lcom/android/flymexxlib/HelpUtils;->uriWithAddedParameters(Landroid/content/Context;Landroid/net/Uri;)Landroid/net/Uri;
...
.method public static prepareHelpMenuItem(Landroid/app/Activity;Landroid/view/Menu;ILjava/lang/String;)Z
    ...
    sget v1, Lcom/android/flymexxlib/R$string;->help_feedback_label:I
    ...
    invoke-static {p0, v0, v1, p3}, Lcom/android/flymexxlib/HelpUtils;->prepareHelpMenuItem(Landroid/app/Activity;Landroid/view/MenuItem;Ljava/lang/String;Ljava/lang/String;)Z
...
.method public static prepareHelpMenuItem(Landroid/app/Activity;Landroid/view/Menu;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0, v0, p2, p3}, Lcom/android/flymexxlib/HelpUtils;->prepareHelpMenuItem(Landroid/app/Activity;Landroid/view/MenuItem;Ljava/lang/String;Ljava/lang/String;)Z
...
.method public static prepareHelpMenuItem(Landroid/app/Activity;Landroid/view/MenuItem;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-static {p0, p2, p3}, Lcom/android/flymexxlib/HelpUtils;->getHelpIntent(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    if-eqz v0, :cond_2

    new-instance v1, Lcom/android/flymexxlib/HelpUtils$1;

    invoke-direct {v1, p0, v0}, Lcom/android/flymexxlib/HelpUtils$1;-><init>(Landroid/app/Activity;Landroid/content/Intent;)V
...
.method public static uriWithAddedParameters(Landroid/content/Context;Landroid/net/Uri;)Landroid/net/Uri;
    ...
    sget-object v3, Lcom/android/flymexxlib/HelpUtils;->sCachedVersionCode:Ljava/lang/String;
    ...
    sput-object v3, Lcom/android/flymexxlib/HelpUtils;->sCachedVersionCode:Ljava/lang/String;

    const-string/jumbo v3, "version"

    sget-object v4, Lcom/android/flymexxlib/HelpUtils;->sCachedVersionCode:Ljava/lang/String;
    ...
    sget-object v3, Lcom/android/flymexxlib/HelpUtils;->TAG:Ljava/lang/String;
