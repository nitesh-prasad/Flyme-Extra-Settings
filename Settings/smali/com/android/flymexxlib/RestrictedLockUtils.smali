.class public Lcom/android/flymexxlib/RestrictedLockUtils;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    }
.end annotation
...
.method public static checkIfAccessibilityServiceDisallowed(Landroid/content/Context;Ljava/lang/String;I)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    .locals 8
    ...
    :cond_0
    invoke-static {p0, p2}, Lcom/android/flymexxlib/RestrictedLockUtils;->getProfileOrDeviceOwner(Landroid/content/Context;I)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    ...
    iget-object v6, v0, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;->component:Landroid/content/ComponentName;
    ...
    :cond_1
    invoke-static {p0, p2}, Lcom/android/flymexxlib/RestrictedLockUtils;->getManagedProfileId(Landroid/content/Context;I)I

    move-result v2

    invoke-static {p0, v2}, Lcom/android/flymexxlib/RestrictedLockUtils;->getProfileOrDeviceOwner(Landroid/content/Context;I)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    ...
    iget-object v6, v5, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;->component:Landroid/content/ComponentName;
    ...
    :cond_4
    sget-object v6, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;->MULTIPLE_ENFORCED_ADMIN:Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
...
.method public static checkIfAccountManagementDisabled(Landroid/content/Context;Ljava/lang/String;I)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    .locals 8
...
.method public static checkIfApplicationIsSuspended(Landroid/content/Context;Ljava/lang/String;I)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    .locals 3
...
.method public static checkIfAutoTimeRequired(Landroid/content/Context;)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    .locals 4
    ...
    new-instance v2, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;

    invoke-static {}, Landroid/os/UserHandle;->myUserId()I

    move-result v3

    invoke-direct {v2, v0, v3}, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;-><init>(Landroid/content/ComponentName;I)V
...
.method public static checkIfInputMethodDisallowed(Landroid/content/Context;Ljava/lang/String;I)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    .locals 8
...
.method public static checkIfKeyguardFeaturesDisabled(Landroid/content/Context;II)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    .locals 13
    ...
    new-instance v4, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;

    invoke-direct {v4, v0, p2}, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;-><init>(Landroid/content/ComponentName;I)V

    goto :goto_0

    :cond_3
    sget-object v11, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;->MULTIPLE_ENFORCED_ADMIN:Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    ...
    invoke-direct {v4, v0, v11}, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;-><init>(Landroid/content/ComponentName;I)V
...
.method public static checkIfMaximumTimeToLockIsSet(Landroid/content/Context;)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    .locals 20
    ...
    new-instance v6, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;

    iget v15, v14, Landroid/content/pm/UserInfo;->id:I

    invoke-direct {v6, v2, v15}, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;-><init>(Landroid/content/ComponentName;I)V

    goto :goto_1

    :cond_4
    sget-object v15, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;->MULTIPLE_ENFORCED_ADMIN:Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
...
.method public static checkIfPasswordQualityIsSet(Landroid/content/Context;I)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    .locals 13
    ...
    invoke-direct {v4, v0, p1}, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;-><init>(Landroid/content/ComponentName;I)V
...
.method public static checkIfRemoteContactSearchDisallowed(Landroid/content/Context;I)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    .locals 5
    ...
    :cond_0
    invoke-static {p0, p1}, Lcom/android/flymexxlib/RestrictedLockUtils;->getProfileOwner(Landroid/content/Context;I)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
...
.method public static checkIfRestrictionEnforced(Landroid/content/Context;Ljava/lang/String;I)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    .locals 8
    ...
    invoke-static {p0, p2}, Lcom/android/flymexxlib/RestrictedLockUtils;->getProfileOwner(Landroid/content/Context;I)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    ...
    invoke-static {p0}, Lcom/android/flymexxlib/RestrictedLockUtils;->getDeviceOwner(Landroid/content/Context;)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;

    move-result-object v0

    iget v6, v0, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;->userId:I
    ...
    :cond_6
    sget-object v0, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;->MULTIPLE_ENFORCED_ADMIN:Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
...
.method public static checkIfUninstallBlocked(Landroid/content/Context;Ljava/lang/String;I)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    .locals 6
    ...
    invoke-static {p0, v4, p2}, Lcom/android/flymexxlib/RestrictedLockUtils;->checkIfRestrictionEnforced(Landroid/content/Context;Ljava/lang/String;I)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
...
.method public static getDeviceOwner(Landroid/content/Context;)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    .locals 4
...
.method public static getProfileOrDeviceOwner(Landroid/content/Context;I)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    .locals 4
    ...
    invoke-direct {v2, v0, p1}, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;-><init>(Landroid/content/ComponentName;I)V
...
.method private static getProfileOwner(Landroid/content/Context;I)Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;
    .locals 4
...
.method public static getRestrictedPadlock(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    sget v2, Lcom/android/flymexxlib/R$drawable;->ic_info:I
    ...
    sget v3, Lcom/android/flymexxlib/R$dimen;->restricted_icon_size:I
...
.method public static getShowAdminSupportDetailsIntent(Landroid/content/Context;Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;)Landroid/content/Intent;
    .locals 4
    ...
    iget-object v2, p1, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;->component:Landroid/content/ComponentName;

    if-eqz v2, :cond_0

    const-string/jumbo v2, "android.app.extra.DEVICE_ADMIN"

    iget-object v3, p1, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;->component:Landroid/content/ComponentName;
    ...
    iget v2, p1, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;->userId:I

    const/16 v3, -0x2710

    if-eq v2, v3, :cond_1

    iget v0, p1, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;->userId:I
...
.method private static removeExistingRestrictedSpans(Landroid/text/SpannableStringBuilder;)V
    ...
    const-class v9, Lcom/android/flymexxlib/RestrictedLockImageSpan;

    invoke-virtual {p0, v8, v3, v9}, Landroid/text/SpannableStringBuilder;->getSpans(IILjava/lang/Class;)[Ljava/lang/Object;

    move-result-object v2

    check-cast v2, [Lcom/android/flymexxlib/RestrictedLockImageSpan;
...
.method public static sendShowAdminSupportDetailsIntent(Landroid/content/Context;Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;)V
    .locals 4

    invoke-static {p0, p1}, Lcom/android/flymexxlib/RestrictedLockUtils;->getShowAdminSupportDetailsIntent(Landroid/content/Context;Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;)Landroid/content/Intent;
    ...
    invoke-static {p0, v2}, Lcom/android/flymexxlib/RestrictedLockUtils;->isCurrentUserOrProfile(Landroid/content/Context;I)Z

    move-result v2

    if-eqz v2, :cond_0

    iget v1, p1, Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;->userId:I
...
.method public static setMenuItemAsDisabledByAdmin(Landroid/content/Context;Landroid/view/MenuItem;Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;)V
    .locals 7
    ...
    invoke-static {v2}, Lcom/android/flymexxlib/RestrictedLockUtils;->removeExistingRestrictedSpans(Landroid/text/SpannableStringBuilder;)V

    if-eqz p2, :cond_0

    sget v3, Lcom/android/flymexxlib/R$color;->disabled_text_color:I
    ...
    new-instance v1, Lcom/android/flymexxlib/RestrictedLockImageSpan;

    invoke-direct {v1, p0}, Lcom/android/flymexxlib/RestrictedLockImageSpan;-><init>(Landroid/content/Context;)V
    ...
    new-instance v3, Lcom/android/flymexxlib/RestrictedLockUtils$1;

    invoke-direct {v3, p0, p2}, Lcom/android/flymexxlib/RestrictedLockUtils$1;-><init>(Landroid/content/Context;Lcom/android/flymexxlib/RestrictedLockUtils$EnforcedAdmin;)V
...
.method public static setTextViewAsDisabledByAdmin(Landroid/content/Context;Landroid/widget/TextView;Z)V
    ...
    invoke-static {v1}, Lcom/android/flymexxlib/RestrictedLockUtils;->removeExistingRestrictedSpans(Landroid/text/SpannableStringBuilder;)V

    if-eqz p2, :cond_0

    sget v2, Lcom/android/flymexxlib/R$color;->disabled_text_color:I
    ...
    invoke-static {p0}, Lcom/android/flymexxlib/RestrictedLockUtils;->getRestrictedPadlock(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    sget v3, Lcom/android/flymexxlib/R$dimen;->restricted_icon_padding:I
