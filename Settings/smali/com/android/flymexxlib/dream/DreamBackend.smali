.class public Lcom/android/flymexxlib/dream/DreamBackend;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/flymexxlib/dream/DreamBackend$DreamInfo;,
        Lcom/android/flymexxlib/dream/DreamBackend$DreamInfoComparator;
    }
.end annotation


# instance fields
.field private final mComparator:Lcom/android/flymexxlib/dream/DreamBackend$DreamInfoComparator;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/android/flymexxlib/dream/DreamBackend;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/android/flymexxlib/dream/DreamBackend;->mDreamManager:Landroid/service/dreams/IDreamManager;

    new-instance v0, Lcom/android/flymexxlib/dream/DreamBackend$DreamInfoComparator;

    invoke-virtual {p0}, Lcom/android/flymexxlib/dream/DreamBackend;->getDefaultDream()Landroid/content/ComponentName;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/android/flymexxlib/dream/DreamBackend$DreamInfoComparator;-><init>(Landroid/content/ComponentName;)V

    iput-object v0, p0, Lcom/android/flymexxlib/dream/DreamBackend;->mComparator:Lcom/android/flymexxlib/dream/DreamBackend$DreamInfoComparator;
    ...
    iput-boolean v0, p0, Lcom/android/flymexxlib/dream/DreamBackend;->mDreamsEnabledByDefault:Z
    ...
    iput-boolean v0, p0, Lcom/android/flymexxlib/dream/DreamBackend;->mDreamsActivatedOnSleepByDefault:Z
    ...
    iput-boolean v0, p0, Lcom/android/flymexxlib/dream/DreamBackend;->mDreamsActivatedOnDockByDefault:Z
...
.method private getBoolean(Ljava/lang/String;Z)Z
    ...
    iget-object v0, p0, Lcom/android/flymexxlib/dream/DreamBackend;->mContext:Landroid/content/Context;
...
.method public getActiveDream()Landroid/content/ComponentName;
    ...
    iget-object v3, p0, Lcom/android/flymexxlib/dream/DreamBackend;->mDreamManager:Landroid/service/dreams/IDreamManager;
...
.method public getActiveDreamName()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Lcom/android/flymexxlib/dream/DreamBackend;->getActiveDream()Landroid/content/ComponentName;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v4, p0, Lcom/android/flymexxlib/dream/DreamBackend;->mContext:Landroid/content/Context;
...
.method public getDefaultDream()Landroid/content/ComponentName;
    ...
    iget-object v1, p0, Lcom/android/flymexxlib/dream/DreamBackend;->mDreamManager:Landroid/service/dreams/IDreamManager;
...
.method public getDreamInfos()Ljava/util/List;
    ...
    invoke-static {v8, v9}, Lcom/android/flymexxlib/dream/DreamBackend;->logd(Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p0}, Lcom/android/flymexxlib/dream/DreamBackend;->getActiveDream()Landroid/content/ComponentName;

    move-result-object v0

    iget-object v8, p0, Lcom/android/flymexxlib/dream/DreamBackend;->mContext:Landroid/content/Context;
    ...
    new-instance v1, Lcom/android/flymexxlib/dream/DreamBackend$DreamInfo;

    invoke-direct {v1}, Lcom/android/flymexxlib/dream/DreamBackend$DreamInfo;-><init>()V
    ...
    iput-object v8, v1, Lcom/android/flymexxlib/dream/DreamBackend$DreamInfo;->caption:Ljava/lang/CharSequence;
    ...
    iput-object v8, v1, Lcom/android/flymexxlib/dream/DreamBackend$DreamInfo;->icon:Landroid/graphics/drawable/Drawable;

    invoke-static {v5}, Lcom/android/flymexxlib/dream/DreamBackend;->getDreamComponentName(Landroid/content/pm/ResolveInfo;)Landroid/content/ComponentName;

    move-result-object v8

    iput-object v8, v1, Lcom/android/flymexxlib/dream/DreamBackend$DreamInfo;->componentName:Landroid/content/ComponentName;

    iget-object v8, v1, Lcom/android/flymexxlib/dream/DreamBackend$DreamInfo;->componentName:Landroid/content/ComponentName;

    invoke-virtual {v8, v0}, Landroid/content/ComponentName;->equals(Ljava/lang/Object;)Z

    move-result v8

    iput-boolean v8, v1, Lcom/android/flymexxlib/dream/DreamBackend$DreamInfo;->isActive:Z

    invoke-static {v4, v5}, Lcom/android/flymexxlib/dream/DreamBackend;->getSettingsComponentName(Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;)Landroid/content/ComponentName;

    move-result-object v8

    iput-object v8, v1, Lcom/android/flymexxlib/dream/DreamBackend$DreamInfo;->settingsComponentName:Landroid/content/ComponentName;
    ...
    :cond_1
    iget-object v8, p0, Lcom/android/flymexxlib/dream/DreamBackend;->mComparator:Lcom/android/flymexxlib/dream/DreamBackend$DreamInfoComparator;
...
.method public isActivatedOnDock()Z
    ...
    iget-boolean v1, p0, Lcom/android/flymexxlib/dream/DreamBackend;->mDreamsActivatedOnDockByDefault:Z

    invoke-direct {p0, v0, v1}, Lcom/android/flymexxlib/dream/DreamBackend;->getBoolean(Ljava/lang/String;Z)Z
...
.method public isActivatedOnSleep()Z
    ...
    iget-boolean v1, p0, Lcom/android/flymexxlib/dream/DreamBackend;->mDreamsActivatedOnSleepByDefault:Z
...
.method public isEnabled()Z
    ...
    iget-boolean v1, p0, Lcom/android/flymexxlib/dream/DreamBackend;->mDreamsEnabledByDefault:Z
...
.method public launchSettings(Lcom/android/flymexxlib/dream/DreamBackend$DreamInfo;)V
    .locals 3
    ...
    invoke-static {v0, v1}, Lcom/android/flymexxlib/dream/DreamBackend;->logd(Ljava/lang/String;[Ljava/lang/Object;)V

    if-eqz p1, :cond_0

    iget-object v0, p1, Lcom/android/flymexxlib/dream/DreamBackend$DreamInfo;->settingsComponentName:Landroid/content/ComponentName;
    ...
    iget-object v2, p1, Lcom/android/flymexxlib/dream/DreamBackend$DreamInfo;->settingsComponentName:Landroid/content/ComponentName;
...
.method public setActivatedOnDock(Z)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/flymexxlib/dream/DreamBackend;->setBoolean(Ljava/lang/String;Z)V
...
.method public setActiveDream(Landroid/content/ComponentName;)V
    ...
    invoke-static {v3, v4}, Lcom/android/flymexxlib/dream/DreamBackend;->logd(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public startDreaming()V
    ...
    invoke-static {v1, v2}, Lcom/android/flymexxlib/dream/DreamBackend;->logd(Ljava/lang/String;[Ljava/lang/Object;)V
